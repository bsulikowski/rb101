...
# There is a difference but they will return the same value. In the first implementation, 
# the input argument buffer will be modified and changed after the method returns. The second
# will not since we are assigning the result to a new variable in the method.